...
function newPost(searchParams, ID) {
    ...
    console.log(`This new post will have user_id of ${ID} and message of ${searchParams.messageInput}`);
    if (ID > 0) {
        const values = [
            ID,
        ...
        return dbConnection
            .query(`INSERT INTO posts (user_id, text_content) VALUES ($1, $2)`, values)
